...
class ODESolver(ABC):
    def __init__(
        ...
        assert algorithm_type in ["data_prediction", "noise_prediction", "velocity_prediction"]
    ...
    def data_prediction_fn(self, x, t):
        ...
        # print(x.shape, noise.shape, alpha_t.shape, sigma_t.shape)
    ...
    def get_time_steps(self, skip_type, t_T, t_0, N, device):
        ...
        if skip_type == 'logsnr':
            ...
            raise ValueError("Unsupported skip_type {}, need to be 'logsnr' or 'time_uniform' or 'time_quadratic' or 'polynomial' or 'dmn'".format(skip_type))
    ...
    def prepare_timesteps_single(self, steps, NFEs, t_start, t_end, flags, device, skip_type='uniform'):
        if flags.learn:
    ...
    @abstractmethod
    def forward(self, model_fn, x, timesteps, timesteps2=None, condition=None, unconditional_condition=None, **kwargs):
        pass 
...
class MultiStepODESolver(GUIDEDSolver):
    ...
    def sample(self, x, steps=20, t_start=None, t_end=None, order=2, skip_type='uniform', flags=None):
