...
class DPM_Solver_v3:
    def __init__(
        ...
        if skip_type == "logSNR" or skip_type == "uniform" or skip_type == "time_quadratic":
    ...
    def get_time_steps(self, skip_type, t_T, t_0, N, device):
        ...
        Args:
            skip_type: A `str`. The type for the spacing of the time steps. We support three types:
                ...
                - 'uniform': uniform time for the time steps. (**Recommended for high-resolutional data**.)
        ...
        if skip_type == "logSNR":
            ...
            raise ValueError(
                "Unsupported skip_type {}, need to be 'logSNR' or 'uniform' or 'time_quadratic'".format(skip_type)
            )
